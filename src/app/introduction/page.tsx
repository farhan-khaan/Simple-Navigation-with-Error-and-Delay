    ...
    export default function Introduction () {
      return (
        <div className="bg-yellow-300 p-10">
            ...
            At Khan Academy, we understand that every student learns differently. Thats why we provide personalized support and resources tailored to each learner's needs. Our experienced educators are dedicated to guiding students on their learning journeys, helping them build confidence and independence. Join us at Khan Academy, where creativity meets mental growth, and lets embark on this exciting journey of learning together!
            </p>
            </div>
        </div>
